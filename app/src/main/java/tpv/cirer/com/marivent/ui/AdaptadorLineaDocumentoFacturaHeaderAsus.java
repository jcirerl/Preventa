...
public class AdaptadorLineaDocumentoFacturaHeaderAsus extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    */   public AdaptadorLineaDocumentoFacturaHeaderAsus(Context context, List<LineaDocumentoFactura> LineaDocumentoFactura, String estado) {
