...
public class AdaptadorLineaDocumentoFacturaHeaderSony extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    */   public AdaptadorLineaDocumentoFacturaHeaderSony(Context context, List<LineaDocumentoFactura> LineaDocumentoFactura, String estado) {
