...
public class FragmentoPagesFactura
        extends Fragment {
    ...
    public FragmentoPagesFactura() {
    }

    private static FragmentoPagesFactura PagesFactura = null;

    public static FragmentoPagesFactura newInstance(int id, String estado, String mesa, String serie, String factura, String total, String obs) {
        FragmentoPagesFactura PagesFactura = new FragmentoPagesFactura();
    ...
    public static FragmentoPagesFactura getInstance(){
        if(PagesFactura == null){
            PagesFactura = new FragmentoPagesFactura();
        }
        return PagesFactura;
    }
...
//            one = ColorFragment.newInstance(COLOR_ONE);
            one = FragmentoLineaDocumentoFactura.newInstance(nId,cEstado,sSerie,nFactura,cTotal,cObs);
...
//            two = new FragmentoCategorias();
        ...
        if (viewPager != null) {
            viewPager.setAdapter(new FragmentoPagesFactura.TwoFragmentAdapter(fragmentManager, one, two));
...
*/    /**
    ...
    public static class ColorFragment extends Fragment {
        ...
        public static FragmentoPagesFactura.ColorFragment newInstance(int color) {
            Bundle arguments = new Bundle();
            arguments.putInt(KEY_COLOR, color);

            FragmentoPagesFactura.ColorFragment fragment = new FragmentoPagesFactura.ColorFragment();
