...
public class AdaptadorLineaDocumentoFacturaHeaderOchoPulgadas extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    */   public AdaptadorLineaDocumentoFacturaHeaderOchoPulgadas(Context context, List<LineaDocumentoFactura> LineaDocumentoFactura, String estado) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == TYPE_ITEM) {
            View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_row_lineadocumentofactura_ochopulgadas, parent, false);
            ...
            View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.header_lineasfacturas_ochopulgadas, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if (holder instanceof VHItem) {
            ...
            /*para filtro*/
                ...
                myText =LineaDocumentoFactura.getLineaDocumentoFacturaNombre().substring(0,(lennombre>23 ? 23 : lennombre));
                ...
                ((VHItem) holder).NombreLineaDocumentoFactura.setText(newText);
