    ...
    */
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == TYPE_ITEM) {
            View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_row_documentopedido, parent, false);
...
////                ((VHItem) holder).ObsDocumentoPedido.setText(DocumentoPedido.getDocumentoPedidoObs().trim()+fixString);
            ...
            /// SONY
/*            myText = " "+
                    ActividadPrincipal.getPalabras("Pedido")+space05+
                    ActividadPrincipal.getPalabras("Fecha")+space05+space01+
                    ActividadPrincipal.getPalabras("Mesa")+space10+space01+space01+
                    ActividadPrincipal.getPalabras("Estado")+space10+
                    ActividadPrincipal.getPalabras("Usuario")+space10+space01+
                    ActividadPrincipal.getPalabras("Caja")+space10+space01+space01+
                    ActividadPrincipal.getPalabras("Turno")+space10+
                    ActividadPrincipal.getPalabras("Lineas")+"  "+
