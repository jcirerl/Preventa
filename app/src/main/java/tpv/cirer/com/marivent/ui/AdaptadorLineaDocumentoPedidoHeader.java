...
public class AdaptadorLineaDocumentoPedidoHeader extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    */   public AdaptadorLineaDocumentoPedidoHeader(Context context, List<LineaDocumentoPedido> LineaDocumentoPedido, String estado) {
