...
public class FragmentoCloseCaja  extends Fragment {
    ...
    private static FragmentoCloseCaja CloseCaja = null;

    public static FragmentoCloseCaja newInstance(int page, String title) {
        FragmentoCloseCaja CloseCaja = new FragmentoCloseCaja();
        Bundle args = new Bundle();
        args.putInt("someInt", page);
        args.putString("someTitle", title);
        CloseCaja.setArguments(args);
        return CloseCaja;
    }

    public static FragmentoCloseCaja getInstance(){
        if(CloseCaja == null){
            CloseCaja = new FragmentoCloseCaja();
        }
        return CloseCaja;
    }

    public FragmentoCloseCaja() {
    }
    @Override
...
*/            RecyclerView.ItemDecoration itemDecoration =
            ...
            btnFab.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Snackbar.make(view, "No se puede crear CAJA", Snackbar.LENGTH_LONG).show();
                }
            });
...
//        return inflater.inflate(R.layout.fragmento_tarjetas, container, false);
    ...
    public void setUserVisibleHint(boolean isVisibleToUser) {
        ...
        if (this.isVisible()) {
            ...
            if (!isVisibleToUser) {
                Log.d("FragmentoCloseCaja", "Not visible anymore.");
                // TODO stop audio playback
            }else{
                Log.d("FragmentoCloseCaja", "Yes visible anymore.");
                onResume();
            }
        }
    }
    ...
    public void onResume() {
        super.onResume();
        new FragmentoCloseCaja.AsyncHttpTaskCaja(cont).execute(url);
    }
    ...
    public class AsyncHttpTaskCaja extends AsyncTask<String, Void, Integer> {
        ...
        protected void onPreExecute() {
            ...
            if(mContext!=null) {
                ...
                pDialog.setMessage("Leyendo Cajas..");
...
//            Integer result = 0;
            ...
            xWhere += " AND caja.APERTURA=0";
            xWhere += " AND caja.CAJA<>'00'"; // CAJA 00 NO DEBE TENERLA EN CUENTA
...
//                Log.d(TAG, e.getLocalizedMessage());
        ...
        protected void onPostExecute(Integer result) {
            ...
            if (result == 1) {
                Log.i("ADAPTADOR CAJA", Integer.toString(adaptadorcaja.getItemCount()));
...
*/             Log.i("Longitud Datos: ",Integer.toString(posts.length()));
            for (int ii = 0; ii < posts.length(); ii++) {
                ...
                cajaItem.setCajaUrlimagenclose(Filtro.getUrl() + "/image/" + post.optString("IMAGEN_CLOSE").trim());
                lcaja.add(cajaItem);
            }
