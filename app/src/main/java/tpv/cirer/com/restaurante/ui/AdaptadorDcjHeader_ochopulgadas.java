...
import tpv.cirer.com.restaurante.herramientas.IMyDcjViewHolderClicks;
...
public class AdaptadorDcjHeader_ochopulgadas extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    */
    public AdaptadorDcjHeader_ochopulgadas(Context context, List<Dcj> Dcj) {
        this.mDcj = Dcj;
...
*/
            ...
            myText = ActividadPrincipal.getPalabras("Turno")+ StringUtils.repeat(space01, 10)+
                     ActividadPrincipal.getPalabras("Fecha")+StringUtils.repeat(space01, 10)+
                     ActividadPrincipal.getPalabras("Saldo Inicio")+StringUtils.repeat(space01, 15)+
                     ActividadPrincipal.getPalabras("Saldo Final")+space05+
                     ActividadPrincipal.getPalabras("Apertura")+StringUtils.repeat(space01, 15)+
                     ActividadPrincipal.getPalabras("Cierre")+StringUtils.repeat(space01, 8)+
                     ActividadPrincipal.getPalabras("Iva");
