...
public class CabeceraFtp {
    private String CabeceraTelefono;
    private String CabeceraEMail;
    private String CabeceraWeb;
    private String CabeceraImp_total;
    private String CabeceraImp_cobro;
    private String CabeceraImp_diferencia;
    private String CabeceraGrupo;
    private String CabeceraEmpresa;
    private String CabeceraSerie;
    ...
    private String CabeceraT_fra;
    private String CabeceraNombre_tft;
    ...
    public String getCabeceraTelefono() {
        return CabeceraTelefono;
    }
    public void setCabeceraTelefono(String cabeceratelefono) {
        this.CabeceraTelefono = cabeceratelefono;
    }
    public String getCabeceraEMail() {
        return CabeceraEMail;
    }
    public void setCabeceraEMail(String cabeceraemail) {
        this.CabeceraEMail = cabeceraemail;
    }

    public String getCabeceraWeb() {
        return CabeceraWeb;
    }
    public void setCabeceraWeb(String cabeceraweb) {
        this.CabeceraWeb = cabeceraweb;
    }
    ...
    public String getCabeceraImp_cobro() {
        return CabeceraImp_cobro;
    }
    public void setCabeceraImp_cobro(String cabeceraimp_cobro) {
        this.CabeceraImp_cobro = cabeceraimp_cobro;
    }

    public String getCabeceraImp_diferencia() {
        return CabeceraImp_diferencia;
    }
    ...
    public void setCabeceraSerie(String cabeceraSerie ){
    ...
    public String getCabeceraMensaje(){
        return this.CabeceraMensaje;
    }
    public void setCabeceraMensaje(String cabeceraMensaje ){
        this.CabeceraMensaje = cabeceraMensaje;
    }
    public void setCabeceraNombre_tft(String cabeceraNombre_tft ){
        this.CabeceraNombre_tft = cabeceraNombre_tft;
    }

    public void setCabeceraImagen_firma(String cabeceraImagen_firma){
        this.CabeceraImagen_firma = cabeceraImagen_firma;
    }
    public String getCabeceraObs(){
        return this.CabeceraObs;
    }

    public String getCabeceraNombre_tft(){
        return this.CabeceraNombre_tft;
    }

    public String getCabeceraImagen_firma(){
        return this.CabeceraImagen_firma;
    }
    public String getCabeceraSerie(){
    ...
    public int getCabeceraEfectivo() {
        return CabeceraEfectivo;
    }
    public void setCabeceraEfectivo(int cabeceraEfectivo) {
        this.CabeceraEfectivo = cabeceraEfectivo;
    }
