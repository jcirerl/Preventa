...
public class WebadminActivity extends AppCompatActivity {
    Button b1;
    EditText ed1;
...
*/        wv1=(WebView)findViewById(R.id.webView);
        wv1.setWebViewClient(new WebadminActivity.CustomWebViewClient());
        String url = Filtro.getUrl_admin();
...
/*        b1.setOnClickListener(new View.OnClickListener() {
    ...
    private class CustomWebViewClient extends WebViewClient {
        ...
        public boolean shouldOverrideUrlLoading(WebView webView, String url) {
            ...
            PackageManager packageManager = WebadminActivity.this.getPackageManager();
            Intent browseIntent = new Intent(Intent.ACTION_VIEW).setData(parsedUri);
            if (browseIntent.resolveActivity(packageManager) != null) {
                WebadminActivity.this.startActivity(browseIntent);
                return true;
            }
            ...
            if (url.startsWith("intent:")) {
                try {
                    ...
                    if (intent.resolveActivity(WebadminActivity.this.getPackageManager()) != null) {
                        WebadminActivity.this.startActivity(intent);
                        return true;
                    }
                    ...
                    if (marketIntent.resolveActivity(packageManager) != null) {
                        WebadminActivity.this.startActivity(marketIntent);
                        return true;
                    }
