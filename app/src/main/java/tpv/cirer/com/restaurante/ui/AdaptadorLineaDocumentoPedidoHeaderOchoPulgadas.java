...
import tpv.cirer.com.restaurante.herramientas.IMyLineaDocumentoPedidoViewHolderClicks;
...
public class AdaptadorLineaDocumentoPedidoHeaderOchoPulgadas extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    */   public AdaptadorLineaDocumentoPedidoHeaderOchoPulgadas(Context context, List<LineaDocumentoPedido> LineaDocumentoPedido, String estado) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == TYPE_ITEM) {
            View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_row_lineadocumentopedido_ochopulgadas, parent, false);
            ...
            View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.header_lineaspedidos_ochopulgadas, parent, false);
...
*/
                ...
                myText = myText.replaceAll("\\s+$", ""); // Quitamos espacios derecha
                newText=myText;
                ((VHItem) holder).NombreLineaDocumentoPedido.setText(newText);
                ...
                myText = myText.replaceAll("\\s+$", ""); // Quitamos espacios derecha
                newText=myText;
                ((VHItem) holder).NombrePlatoLineaDocumentoPedido.setText(newText);

                ((VHItem) holder).NombreLineaDocumentoPedido.setText(((VHItem) holder).NombreLineaDocumentoPedido.getText().toString().trim()+" "+((VHItem) holder).NombrePlatoLineaDocumentoPedido.getText().toString().trim());
