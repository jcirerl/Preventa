package tpv.cirer.com.restaurante.print;
...
public class ShowMsg {
    ...
    public static void showError(int errMsg, Context context){
        String msg = context.getString(errMsg);
        show(msg, context);
    }
    
    public static void showStatus(int result, int status, int battery, Context context){
        String msg;
        msg = String.format(
                "%s\n\t%s\n%s\n%s\n%s\n\t0x%04X",
    ...
    public static void showPrinterName(String printerName, String languageName, Context context){
        String msg;
        msg = String.format(
                "%s\n\t%s\n%s\n\t%s",
    ...
    public static void showStatusChangeEvent(String deviceName, int status, Context context){
        String msg;
        msg = String.format(
                "%s\n\t%s\n%s\n%s",
