...
import tpv.cirer.com.restaurante.herramientas.IMyDocumentoPedidoViewHolderClicks;
...
public class AdaptadorDocumentoPedidoHeaderOchoPulgadas extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    */
    public AdaptadorDocumentoPedidoHeaderOchoPulgadas(Context context, List<DocumentoPedido> DocumentoPedido) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == TYPE_ITEM) {
            View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_row_documentopedido_ochopulgadas, parent, false);
...
////                ((VHItem) holder).ObsDocumentoPedido.setText(DocumentoPedido.getDocumentoPedidoObs().trim()+fixString);
            ...
            myText = " "+
                    ...
                    ActividadPrincipal.getPalabras("Fecha")+StringUtils.repeat(space01, 3)+
                    ActividadPrincipal.getPalabras("Np")+ StringUtils.repeat(space01, 2)+
                    ActividadPrincipal.getPalabras("Mesa")+StringUtils.repeat(space01, 4)+
                    ActividadPrincipal.getPalabras("Estado")+StringUtils.repeat(space01, 5)+
                    ActividadPrincipal.getPalabras("Usuario")+StringUtils.repeat(space01, 8)+
                    ActividadPrincipal.getPalabras("Caja")+StringUtils.repeat(space01, 4)+
                    ActividadPrincipal.getPalabras("Turno")+StringUtils.repeat(space01, 2)+
