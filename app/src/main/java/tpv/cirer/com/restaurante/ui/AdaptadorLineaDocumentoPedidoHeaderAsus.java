...
public class AdaptadorLineaDocumentoPedidoHeaderAsus  extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    */   public AdaptadorLineaDocumentoPedidoHeaderAsus(Context context, List<LineaDocumentoPedido> LineaDocumentoPedido, String estado) {
