...
import tpv.cirer.com.restaurante.herramientas.ImageAndTextContainer;
...
public class PrintTicketPrintDocumentAdapter  extends PrintDocumentAdapter {
    ...
    public PrintTicketPrintDocumentAdapter(ImageAndTextContainer container, Context cxt) {
