...
import tpv.cirer.com.restaurante.herramientas.IMySeccionViewHolderClicks;
...
public class AdaptadorSeccionHeader_ochopulgadas extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    */
    public AdaptadorSeccionHeader_ochopulgadas(Context context, List<Seccion> Seccion) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == TYPE_ITEM) {
            ...
            return new AdaptadorSeccionHeader_ochopulgadas.VHItem(v, new IMySeccionViewHolderClicks() {
...
*/                        dialog.cancel();
            ...
            return new AdaptadorSeccionHeader_ochopulgadas.VHHeader(v);
        }
...
//        if ((AdaptadorSeccionHeader.VHItem) == vhitem) {
            ...
            myText = ActividadPrincipal.getPalabras("Seccion")+"     "+
                     ...
                     ActividadPrincipal.getPalabras("Fecha Apertura")+space50+
