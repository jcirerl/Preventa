...
public class AdaptadorDocumentoPedidoHeaderSony  extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    */
    public AdaptadorDocumentoPedidoHeaderSony(Context context, List<DocumentoPedido> DocumentoPedido) {
