...
public class AdaptadorDocumentoPedidoHeaderAsus  extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    */
    public AdaptadorDocumentoPedidoHeaderAsus(Context context, List<DocumentoPedido> DocumentoPedido) {
