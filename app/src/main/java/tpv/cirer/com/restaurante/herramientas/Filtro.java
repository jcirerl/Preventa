...
public class Filtro {
    ...
    private static String url_redsys;
    ...
    public static void setOptipotablet(int idoptipotablet) {
    ...
    public static String getUrl_admin() {
        return url_admin;
    }
    public static void setUrl_admin(String idurladmin) {
        url_admin = idurladmin;
    }

    public static String getUrl_redsys() {
        return url_redsys;
    }
    public static void setUrl_redsys(String idurlredsys) {
        url_redsys = idurlredsys;
    }
